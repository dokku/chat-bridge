...
RUN curl -L "https://github.com/gliderlabs/sigil/releases/download/v0.11.0/gliderlabs-sigil_0.11.0_linux_amd64.tgz" | tar -zxC /bin && mv /bin/gliderlabs-sigil-amd64 /bin/sigil
